        ...
        <v-card variant="tonal">
          <v-card-text>
            ...
            <div class="d-flex justify-center my-2">
              <h1
                class="font-weight-light primary-- text-h4"
                v-html="resumeMetaData?.messages?.delivered" />
            </div>
            <div class="d-flex my-2">
              <h3
                class="font-weight-light primary-- text-h6 text-center"
                v-html="resumeMetaData?.messages?.success" />
            </div>
...
const { siteMetaData: resumeMetaData } = storeToRefs(store);

const errorTitle = computed(() => resumeMetaData.value.messages?.emailErrorTitle);
const errorMessage = computed(() => resumeMetaData.value.messages?.emailErrorMessage);
