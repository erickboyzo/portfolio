  ...
  PROFESSIONAL_SKILLS: [
    {
      ...
      text: "Develop user interfaces that are both visually appealing and implement responsive and interactive user interfaces.",
      experience: 90,
    },
    {
      icon: "mdi-monitor",
      label: "Web Application Development",
      text: "Build robust web applications using frameworks like React, Angular, or Vue.js, alongside backend technologies such as Node.js or Spring.",
      experience: 95,
    },
    {
      icon: "mdi-tablet-cellphone",
      label: "Mobile Application Development",
      text: "Utilize both native and cross-platform frameworks to develop applications that are both high-performing and user-friendly.",
      experience: 80,
    },
    {
      icon: "mdi-cogs",
      label: "Automation",
      text: "Leverage automation technologies to enhance scripts and workflows that minimize manual intervention and decrease human intervention.",
      experience: 70,
    },
  ],
